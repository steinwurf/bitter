...
// TEST(test_bit_reader_big_endian, read_bit)
// {
...
//     auto reader =
//          bitter::bitfield_reader<endian::big_endian, 8,8,8,8,8>(data);
...
// TEST(test_bit_reader_big_endian, read_bit2)
// {
//     std::vector<uint8_t> data
//     {
//         0x00, //0000 0000
...
// TEST(test_bit_reader_big_endian, read_bit3)
// {
//     std::vector<uint8_t> data
//     {
//         0x00, //0000 0000
...
// TEST(test_bit_reader_big_endian, read_bit4)
// {
//     std::vector<uint8_t> data
//     {
//         0x00, //0000 0000
...
// TEST(test_bit_reader_big_endian, read_bit5)
// {
//     std::vector<uint8_t> data
//     {
//         0xA0, //1010 0000
...
// TEST(test_bit_reader_big_endian, read_bit6)
// {
//     std::vector<uint8_t> data
//     {
//         0x00, //0000 0000
